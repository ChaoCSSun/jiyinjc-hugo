...
echo "                                    version 1.0"
echo ""
echoitalic "* Written by  : <chao>"
echoitalic "* E-mail      : sc_kris@163.com"
...
ROOT="/Users/csun/hugo-projects/jiyinjc-hugo/"
WEBSITE="${ROOT}/jiyinjc-website"
...
### 'CNAME' file.
echo "http://jiyinjc.vip" > ${WEBSITEPUBLIC}/CNAME

echo "* Going to 'public' folder..."

cd ${ROOT}/ChaoCSSun.github.io

cp -afv ${ROOT}/jiyinjc-website/public/* .
